...
public class UserImpl extends org.springframework.security.core.userdetails.User{
    ...
    private br.edu.ifrs.canoas.lds.domain.User user;

    public UserImpl(String username, String password, Collection<? extends GrantedAuthority> authorities, br.edu.ifrs.canoas.lds.domain.User user) {
    ...
    public br.edu.ifrs.canoas.lds.domain.User getUser() {
        return user;
    }
}
